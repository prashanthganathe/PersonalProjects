...
namespace BlockStyleColor
{
    ...
    /// </summary>
    public sealed partial class AdminHome : BlockStyleColor.Common.LayoutAwarePage
    {
        public AdminHome()
        {
        ...
        private void Grid_Tapped_Users(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(UsersList));
        }
