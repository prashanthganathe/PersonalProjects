...
/*	define('QA_MYSQL_HOSTNAME', 'localhost'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	...
	define('QA_MYSQL_DATABASE', 'questionsdb');
	*/
	
	define('QA_MYSQL_HOSTNAME', 'prashanthganathe.ipagemysql.com'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'prashanthganathe');
	define('QA_MYSQL_PASSWORD', 'QuatreBornes123!');
	define('QA_MYSQL_DATABASE', 'askmeexpertdb_sep08');
