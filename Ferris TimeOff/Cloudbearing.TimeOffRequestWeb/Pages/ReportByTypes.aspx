<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportByTypes.aspx.cs" Inherits="Cloudbearing.TimeOffRequestWeb.Pages.ReportByTypes" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function FillLevel3Details(e, requestedbyid) {
                ...
                $.ajax({
                    type: "POST",
                    url: "ReportByTypes.aspx/GetDetails",
                    data: JSON.stringify({ 'year': yearselected, 'parameterkey': 'TimeOffType', 'parametervalue': requestedbyid, 'startdate': StartDate, 'enddate': EndDate, 'starttime': StartTime, 'endtime': EndTime }),
            ...
            function FillLevel2(items) {
                ...
                $.each(items, function (index, item) {
                    ...
                    listtemplate += "<span class='ui-accordion-header-icon ui-icon ui-icon-triangle-1-e'></span><span class='level2header' id='" + item.TimeOffType + "'><span  class='requestedby' >" + item.TimeOffType + "</span><span style='float:right;margin-right:40px;'><b>" + item.TotalHours + "</b></span></span>";
           ...
           <div class="page-header">
            <div class="page-header-content" style="width:100%;margin-left:40px;">
             <div style="float:left; width:10%;"><a onclick="Redirect('Ui.aspx')" class="back-button big page-back"></a></div>
              <div style="float:left; width:90%; margin-left:-50px"><h2>All Time Off Requests by Type<small></small></h2></div>
          </div>
         </div>
...
<div id="wait" style="display:none;position:absolute;top:50%;left:50%;padding:2px; z-index:3000;">
 ...
 <div id="AccordianParent" style="width:99.5%; padding-left:50px;margin-top:20px;">
              ...
              <div class="divSingleline ui-helper-reset ui-state-default " style="width:8%;padding-right:8px;height:35px; ">Type</div>
              <div class="divSingleline ui-helper-reset ui-state-default " style="width:13%;padding-right:8px;height:35px; ">Requestor</div>            
