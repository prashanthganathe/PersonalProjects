...
{
    public partial class SummaryReport : PreInitPage
    {
        User CurrentUser;
        ...
        public static List<YearPoco> GetEmployeeDetailsByYear( string year, string startdate, string enddate, string starttime, string endtime)
        {           
            if (HttpContext.Current.Session["CurrentSPContext"] != null)
            {
                ...
                return obj.GetDetailsByYearEmployee(HttpContext.Current.Session["CurrentSPContext"] as SharePointContext, year, startDate, endDate);
            }
