...
{
    public partial class ReportByTypes : System.Web.UI.Page
    {
        User CurrentUser;
        ...
        public static List<YearPoco> GetDetailsByYearType(string year, string startdate, string enddate, string starttime, string endtime)
        {
            if (HttpContext.Current.Session["CurrentSPContext"] != null)
            {
                ...
                return obj.GetDetailsByYearType(HttpContext.Current.Session["CurrentSPContext"] as SharePointContext, year, startDate, endDate);
            }
