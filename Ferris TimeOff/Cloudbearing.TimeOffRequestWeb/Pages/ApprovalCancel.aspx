<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalCancel.aspx.cs" Inherits="Cloudbearing.TimeOffRequestWeb.Pages.ApprovalCancel" %>
			                ...
			                <div class="page-region-content">				         
                                      <div class="divSingleline " style="width:100%;">
                                            <div class="divSingleline" style="width:90%;">
                                                ...
                                                <h2>Time Off Approval Cancel Form</h2> </div>
                                        </div>
                            </div>
                        </div>
                 </div>
                                        ...
                                        <div id="DeltaPlaceHolderMain">	
                                              ...
                                              <div id="divbuttons" runat="server" clientidmode="Static"  style="text-align:left; margin-left:30px; float:left; width: 726px;">
                                                 <asp:Button ID="btnChkCalendar" runat="server" Text="Check Calendar" OnClick="btnChkCalendar_Click" ValidationGroup="validate" class="newAbsencesButton"    />    
                                                  ...
                                                  &nbsp;&nbsp;&nbsp;                        
                                                  <asp:Button ID="btnCancel" runat="server" Text="Cancel Request" OnClick="btnCancel_Click" ValidationGroup="validate" class="newAbsencesButton"/>
                                                  &nbsp;&nbsp;
                                                   </div>	
                                            <br />
                                           ...
                                           <h3><b>Who</b></h3>
                                            ...
                                            <h3><b>When</b></h3>
                                            <h4><span class="ms-textLarge ms-soften label">Requested On <strong>:</strong></span><asp:Label ID="lblRequestedOn" runat="server" ></asp:Label></h4>
