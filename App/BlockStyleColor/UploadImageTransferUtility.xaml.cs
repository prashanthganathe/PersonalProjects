...
namespace BlockStyleColor
{
    ...
    /// </summary>
    public sealed partial class UploadImageTransferUtility : BlockStyleColor.Common.LayoutAwarePage
    {
        public UploadImageTransferUtility()
        {
        ...
        {
            await UploadAmazonTransferUitility();

           
        }

        public async Task UploadAmazonTransferUitility()
        {
